...
export class DatatablePageComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private dataTableService: DataTableService,private cdr: ChangeDetectorRef) {}
  ...
  deleteItem(id: number): void {
    this.dataTableService.deleteItem(id).subscribe(
      () => this.loadData(),
    );
    this.loadData();
  }
